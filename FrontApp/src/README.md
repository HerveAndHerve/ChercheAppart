...
the header and footer. It declares with `ngApp` that this is `trouverDesTerrains`,
...
"trouverDesTerrains" will rename the resultant CSS and JavaScript placed in `build/`,
